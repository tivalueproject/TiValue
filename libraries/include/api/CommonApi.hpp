...
namespace TiValue { namespace api {
  ...
  public:
     ...
     * @return asset
     */
    virtual TiValue::blockchain::Asset blockchain_calculate_supply(const std::string& asset) const = 0;
    /**
     ...
     */
    virtual TiValue::blockchain::BlockchainSecurityState blockchain_get_security_state() const = 0;
    /**
     ...
     */
    virtual std::vector<TiValue::blockchain::AccountEntry> blockchain_list_accounts(const std::string& first_account_name = fc::json::from_string("\"\"").as<std::string>(), uint32_t limit = fc::json::from_string("20").as<uint32_t>()) const = 0;
    /**
     * Returns a list of recently updated accounts.
     *
     * @return account_entry_array
     */
    virtual std::vector<TiValue::blockchain::AccountEntry> blockchain_list_recently_updated_accounts() const = 0;
    /**
     * Returns a list of recently registered accounts.
     *
     * @return account_entry_array
     */
    virtual std::vector<TiValue::blockchain::AccountEntry> blockchain_list_recently_registered_accounts() const = 0;
    /**
     ...
     */
    virtual std::vector<TiValue::blockchain::AssetEntry> blockchain_list_assets(const std::string& first_symbol = fc::json::from_string("\"\"").as<std::string>(), uint32_t limit = fc::json::from_string("20").as<uint32_t>()) const = 0;
    /**
     * Return a list of transactions that are not yet in a block.
     *
     * @return signed_transaction_pair_array
     */
    virtual std::vector<std::pair<TiValue::blockchain::TransactionIdType, TiValue::blockchain::SignedTransaction>> blockchain_list_pending_transactions() const = 0;
    /**
     ...
     */
    virtual std::pair<TiValue::blockchain::TransactionIdType, TiValue::blockchain::TransactionEntry> blockchain_get_transaction(const std::string& transaction_id_prefix, bool exact = fc::json::from_string("false").as<bool>()) const = 0;
    /**
     ...
     */
    virtual TiValue::wallet::PrettyTransaction blockchain_get_pretty_transaction(const std::string& transaction_id_prefix, bool exact = fc::json::from_string("false").as<bool>()) const = 0;
    /**
     ...
     */
    virtual TiValue::wallet::PrettyContractTransaction blockchain_get_pretty_contract_transaction(const std::string& transaction_id_prefix, bool exact = fc::json::from_string("false").as<bool>()) const = 0;
    /**
     ...
     * @return oblock_entry
     */
    virtual fc::optional<TiValue::blockchain::BlockEntry> blockchain_get_block(const std::string& block) const = 0;
    /**
     ...
     */
    virtual std::map<TiValue::blockchain::TransactionIdType, TiValue::blockchain::TransactionEntry> blockchain_get_block_transactions(const std::string& block) const = 0;
    /**
     ...
     */
    virtual fc::optional<TiValue::blockchain::AccountEntry> blockchain_get_account(const std::string& account) const = 0;
    /**
     ...
     */
    virtual std::map<TiValue::blockchain::AccountIdType, std::string> blockchain_get_slate(const std::string& slate) const = 0;
    /**
     ...
     */
    virtual TiValue::blockchain::BalanceEntry blockchain_get_balance(const TiValue::blockchain::Address& balance_id) const = 0;
    /**
     ...
     */
    virtual std::unordered_map<TiValue::blockchain::BalanceIdType, TiValue::blockchain::BalanceEntry> blockchain_list_balances(const std::string& first_balance_id = fc::json::from_string("\"\"").as<std::string>(), uint32_t limit = fc::json::from_string("20").as<uint32_t>()) const = 0;
    /**
     ...
     * @return balance_entry_map
     */
    virtual std::unordered_map<TiValue::blockchain::BalanceIdType, TiValue::blockchain::BalanceEntry> blockchain_list_address_balances(const std::string& addr, const fc::time_point& chanced_since = fc::json::from_string("\"1970-1-1T00:00:01\"").as<fc::time_point>()) const = 0;
    /**
     ...
     */
    virtual TiValue::wallet::AccountBalanceSummaryType blockchain_get_account_public_balance(const std::string& account_name) const = 0;
    /**
     ...
     * @return balance_entry_map
     */
    virtual std::unordered_map<TiValue::blockchain::BalanceIdType, TiValue::blockchain::BalanceEntry> blockchain_list_key_balances(const TiValue::blockchain::PublicKeyType& key) const = 0;
    /**
     ...
     */
    virtual fc::optional<TiValue::blockchain::AssetEntry> blockchain_get_asset(const std::string& asset) const = 0;
    /**
     ...
     * @return account_entry_array
     */
    virtual std::vector<TiValue::blockchain::AccountEntry> blockchain_list_active_delegates(uint32_t first = fc::json::from_string("0").as<uint32_t>(), uint32_t count = fc::json::from_string("20").as<uint32_t>()) const = 0;
    /**
     ...
     * @return account_entry_array
     */
    virtual std::vector<TiValue::blockchain::AccountEntry> blockchain_list_delegates(uint32_t first = fc::json::from_string("0").as<uint32_t>(), uint32_t count = fc::json::from_string("20").as<uint32_t>()) const = 0;
    /**
     ...
     */
    virtual std::vector<TiValue::blockchain::BlockEntry> blockchain_list_blocks(uint32_t max_block_num = fc::json::from_string("-1").as<uint32_t>(), uint32_t limit = fc::json::from_string("20").as<uint32_t>()) = 0;
    /**
     ...
     * @return string
     */
    virtual std::string blockchain_export_fork_graph(uint32_t start_block = fc::json::from_string("1").as<uint32_t>(), uint32_t end_block = fc::json::from_string("-1").as<uint32_t>(), const TiValue::blockchain::FilePath& filename = fc::json::from_string("\"\"").as<TiValue::blockchain::FilePath>()) const = 0;
    /**
     * returns a list of all blocks for which there is a fork off of the main chain.
     *
     * @return map<uint32_t, vector<fork_entry>>
     */
    virtual std::map<uint32_t, std::vector<TiValue::blockchain::ForkEntry>> blockchain_list_forks() const = 0;
    /**
     ...
     */
    virtual std::vector<TiValue::blockchain::SlotEntry> blockchain_get_delegate_slot_entrys(const std::string& delegate_name, uint32_t limit = fc::json::from_string("\"10\"").as<uint32_t>()) const = 0;
    /**
     ...
     * @return asset
     */
    virtual TiValue::blockchain::Asset blockchain_unclaimed_genesis() const = 0;
    /**
     ...
     */
    virtual void blockchain_broadcast_transaction(const TiValue::blockchain::SignedTransaction& trx) = 0;
    /**
     * Convert bitcoin address file to TiValue address file.
     *
     ...
     * @return transaction_id
     */
    virtual TiValue::blockchain::TransactionIdType network_broadcast_transaction(const TiValue::blockchain::SignedTransaction& transaction_to_broadcast) = 0;
    /**
     ...
     */
    virtual TiValue::net::MessagePropagationData network_get_transaction_propagation_data(const TiValue::blockchain::TransactionIdType& transaction_id) = 0;
    /**
     ...
     * @return message_propagation_data
     */
    virtual TiValue::net::MessagePropagationData network_get_block_propagation_data(const TiValue::blockchain::BlockIdType& block_hash) = 0;
    /**
     ...
     */
    virtual std::vector<TiValue::net::PotentialPeerEntry> network_list_potential_peers() const = 0;
    /**
     ...
     */
    virtual void delegate_blacklist_add_transaction(const TiValue::blockchain::TransactionIdType& id) = 0;
    /**
     * Remove specified transaction from blacklist.
     *
     * @param id transaction to remove from blacklist (transaction_id, required)
     */
    virtual void delegate_blacklist_remove_transaction(const TiValue::blockchain::TransactionIdType& id) = 0;
    /**
     * Add specified operation to blacklist.
     *
     * @param id operation to add to blacklist (operation_type, required)
     */
    virtual void delegate_blacklist_add_operation(const TiValue::blockchain::OperationTypeEnum& id) = 0;
    /**
     ...
     */
    virtual std::vector<TiValue::wallet::PrettyTransaction> wallet_account_transaction_history(const std::string& account_name = fc::json::from_string("\"\"").as<std::string>(), const std::string& asset_symbol = fc::json::from_string("\"\"").as<std::string>(), int32_t limit = fc::json::from_string("0").as<int32_t>(), uint32_t start_block_num = fc::json::from_string("0").as<uint32_t>(), uint32_t end_block_num = fc::json::from_string("-1").as<uint32_t>()) const = 0;
    /**
     * Lists transaction history for the specified account.
     *
     * @param account_name the name of the account for which the transaction history will be returned, "" for all
     ...
     * @return pretty_transactions
     */
    virtual std::vector<TiValue::wallet::PrettyTransaction> wallet_transaction_history_splite(const std::string& account_name = fc::json::from_string("\"\"").as<std::string>(), const std::string& asset_symbol = fc::json::from_string("\"\"").as<std::string>(), int32_t limit = fc::json::from_string("0").as<int32_t>(), int32_t transaction_type = fc::json::from_string("\"2\"").as<int32_t>()) const = 0;
    /**
     ...
     * @return account_balance_summary_type
     */
    virtual TiValue::wallet::AccountBalanceSummaryType wallet_account_historic_balance(const fc::time_point& time, const std::string& account_name = fc::json::from_string("\"\"").as<std::string>()) const = 0;
    /**
     ...
     */
    virtual std::map<TiValue::blockchain::TransactionIdType, fc::exception> wallet_get_pending_transaction_errors(const TiValue::blockchain::FilePath& filename = fc::json::from_string("\"\"").as<TiValue::blockchain::FilePath>()) const = 0;
    /**
     ...
     * @return address
     */
    virtual TiValue::blockchain::Address wallet_account_create(const std::string& account_name, const fc::variant& private_data = fc::json::from_string("null").as<fc::variant>()) = 0;
    /**
     ...
     * @return account_entry_array
     */
    virtual std::vector<TiValue::blockchain::AccountEntry> wallet_get_all_approved_accounts(int8_t approval = fc::json::from_string("1").as<int8_t>()) = 0;
    /**
     ...
     * @return transaction_entry
     */
    virtual TiValue::wallet::WalletTransactionEntry wallet_get_transaction(const std::string& transaction_id) = 0;
    /**
     ...
     * @return transaction_entry
     */
    virtual TiValue::wallet::WalletTransactionEntry wallet_scan_transaction(const std::string& transaction_id, bool overwrite_existing = fc::json::from_string("false").as<bool>()) = 0;
    /**
     ...
     * @return transaction_entry
     */
    virtual TiValue::wallet::WalletTransactionEntry wallet_account_update_registration(const std::string& account_name, const std::string& pay_from_account, const fc::variant& public_data = fc::json::from_string("null").as<fc::variant>(), uint8_t delegate_pay_rate = fc::json::from_string("-1").as<uint8_t>()) = 0;
    /**
     ...
     * @return transaction_entry
     */
    virtual TiValue::wallet::WalletTransactionEntry wallet_account_update_active_key(const std::string& account_to_update, const std::string& pay_from_account, const std::string& new_active_key = fc::json::from_string("\"\"").as<std::string>()) = 0;
    /**
     * Lists all accounts associated with this wallet.
     *
     * @return wallet_account_entry_array
     */
    virtual std::vector<TiValue::wallet::WalletAccountEntry> wallet_list_accounts() const = 0;
    /**
     * Lists all unregistered accounts belonging to this wallet.
     *
     * @return wallet_account_entry_array
     */
    virtual std::vector<TiValue::wallet::WalletAccountEntry> wallet_list_unregistered_accounts() const = 0;
    /**
     * Lists all accounts for which we have a private key in this wallet.
     *
     * @return wallet_account_entry_array
     */
    virtual std::vector<TiValue::wallet::WalletAccountEntry> wallet_list_my_accounts() const = 0;
    /**
     ...
     */
    virtual std::vector<TiValue::wallet::AccountAddressData> wallet_list_my_addresses() const = 0;
    /**
     * Get the account entry for a given name.
     *
     ...
     */
    virtual TiValue::wallet::WalletAccountEntry wallet_get_account(const std::string& account_name) const = 0;
    /**
     * Get the account entry for a given name.
     *
     * @param account_name the name of the account whose public address you want (account_name, required)
     ...
     * @return transaction_entry
     */
    virtual TiValue::wallet::WalletTransactionEntry wallet_asset_create(const std::string& symbol, const std::string& asset_name, const std::string& issuer_name, const std::string& description, const std::string& maximum_share_supply, uint64_t precision, const fc::variant& public_data = fc::json::from_string("null").as<fc::variant>(), bool is_market_issued = fc::json::from_string("false").as<bool>()) = 0;
    /**
     ...
     * @return transaction_entry
     */
    virtual TiValue::wallet::WalletTransactionEntry wallet_asset_issue(const std::string& amount, const std::string& symbol, const std::string& to_account_name, const TiValue::blockchain::Imessage& memo_message = fc::json::from_string("\"\"").as<TiValue::blockchain::Imessage>()) = 0;
    /**
     ...
     * @return transaction_entry
     */
    virtual TiValue::wallet::WalletTransactionEntry wallet_asset_issue_to_addresses(const std::string& symbol, const std::map<std::string, TiValue::blockchain::ShareType>& addresses) = 0;
    /**
     ...
     * @return account_balance_summary_type
     */
    virtual TiValue::wallet::AccountBalanceSummaryType wallet_account_balance(const std::string& account_name = fc::json::from_string("\"\"").as<std::string>()) const = 0;
    /**
     ...
     */
    virtual TiValue::wallet::AccountBalanceIdSummaryType wallet_account_balance_ids(const std::string& account_name = fc::json::from_string("\"\"").as<std::string>()) const = 0;
    /**
     ...
     */
    virtual std::vector<TiValue::wallet::PublicKeySummary> wallet_account_list_public_keys(const std::string& account_name) = 0;
    /**
     ...
     * @return transaction_entry
     */
    virtual TiValue::wallet::WalletTransactionEntry wallet_delegate_withdraw_pay(const std::string& delegate_name, const std::string& to_account_name, const std::string& amount_to_withdraw) = 0;
    /**
     ...
     */
    virtual TiValue::blockchain::DelegatePaySalary wallet_delegate_pay_balance_query(const std::string& delegate_name) = 0;
    /**
     * query delegate's pay balance.
     *
     * @return delegate_salary_map
     */
    virtual std::map<std::string,TiValue::blockchain::DelegatePaySalary> wallet_active_delegate_salary() = 0;
    /**
     ...
     * @return asset
     */
    virtual TiValue::blockchain::Asset wallet_set_transaction_fee(const std::string& fee) = 0;
    /**
     * Returns .
     *
     ...
     * @return asset
     */
    virtual TiValue::blockchain::Asset wallet_get_transaction_fee(const std::string& symbol = fc::json::from_string("\"\"").as<std::string>()) = 0;
    /**
     ...
     * @return optional_string
     */
    virtual fc::optional<std::string> wallet_dump_account_private_key(const std::string& account_name, const TiValue::wallet::AccountKeyType& key_type) const = 0;
    /**
     ...
     */
    virtual TiValue::wallet::AccountVoteSummaryType wallet_account_vote_summary(const std::string& account_name = fc::json::from_string("\"\"").as<std::string>()) const = 0;
    /**
     ...
     * @return vote_summary
     */
    virtual TiValue::wallet::VoteSummary wallet_check_vote_status(const std::string& account) = 0;
    /**
     ...
     * @return variant
     */
    virtual fc::variant wallet_login_finish(const TiValue::blockchain::PublicKeyType& server_key, const TiValue::blockchain::PublicKeyType& client_key, const fc::ecc::compact_signature& client_signature) = 0;
    /**
     ...
     * @return transaction_builder
     */
    virtual TiValue::wallet::TransactionBuilder wallet_balance_set_vote_info(const TiValue::blockchain::Address& balance_id, const std::string& voter_address = fc::json::from_string("\"\"").as<std::string>(), const TiValue::wallet::VoteStrategy& strategy = fc::json::from_string("\"vote_all\"").as<TiValue::wallet::VoteStrategy>(), bool sign_and_broadcast = fc::json::from_string("\"true\"").as<bool>(), const std::string& builder_path = fc::json::from_string("\"\"").as<std::string>()) = 0;
    /**
     ...
     * @return transaction_entry
     */
    virtual TiValue::wallet::WalletTransactionEntry wallet_publish_slate(const std::string& publishing_account_name, const std::string& paying_account_name = fc::json::from_string("\"\"").as<std::string>()) = 0;
    /**
     ...
     * @return transaction_entry
     */
    virtual TiValue::wallet::WalletTransactionEntry wallet_publish_version(const std::string& publishing_account_name, const std::string& paying_account_name = fc::json::from_string("\"\"").as<std::string>()) = 0;
    /**
     ...
     * @return transaction_entry
     */
    virtual TiValue::wallet::WalletTransactionEntry wallet_collect_genesis_balances(const std::string& account_name) = 0;
    /**
     ...
     * @return transaction_entry
     */
    virtual TiValue::wallet::WalletTransactionEntry wallet_account_retract(const std::string& account_to_retract, const std::string& pay_from_account) = 0;
    /**
     ...
     * @return public_key
     */
    virtual TiValue::blockchain::PublicKeyType wallet_get_account_owner_publickey(const std::string& account_name) = 0;
    /**
     ...
     * @return transaction_entry
     */
    virtual TiValue::wallet::WalletTransactionEntry wallet_transfer_to_contract(double amount_to_transfer, const std::string& asset_symbol, const std::string& from_account_name, const std::string& to_contract, double amount_for_exec) = 0;
    /**
     * Do a simple transfer to a contract (name or address) on local endpoint, and do not spread it on P2P network.
     *
     * @param amount_to_transfer the amount of shares to transfer (real_amount, required)
     * @param asset_symbol the asset to transfer (asset_symbol, required)
     * @param from_account_name the source account to draw the shares from (account_name, required)
     ...
     * @return asset_array
     */
    virtual std::vector<TiValue::blockchain::Asset> wallet_transfer_to_contract_testing(double amount_to_transfer, const std::string& asset_symbol, const std::string& from_account_name, const std::string& to_contract) = 0;
    /**
     ...
     * @return transaction_entry
     */
    virtual TiValue::wallet::WalletTransactionEntry builder_finalize_and_sign(const TiValue::wallet::TransactionBuilder& builder) const = 0;
    /**
     * Returns help information as JSON data.
     *
     * @return method_map_type
     */
    virtual std::map<std::string, TiValue::api::MethodData> meta_help() const = 0;
    /**
     ...
     * @return asset_array
     */
    virtual std::vector<TiValue::blockchain::Asset> register_contract_testing(const std::string& owner, const fc::path& codefile) = 0;
    /**
     ...
     * @return transaction_entry
     */
    virtual TiValue::wallet::WalletTransactionEntry upgrade_contract(const std::string& contract_address, const std::string& upgrader_name, const std::string& new_contract_name, const TiValue::blockchain::Imessage& new_contract_desc, const std::string& asset_symbol, const fc::optional<double>& exec_limit) = 0;
    /**
     ...
     * @return asset_array
     */
    virtual std::vector<TiValue::blockchain::Asset> upgrade_contract_testing(const std::string& contract_address, const std::string& upgrader_name, const std::string& new_contract_name, const TiValue::blockchain::Imessage& new_contract_desc) = 0;
    /**
     ...
     * @return transaction_entry
     */
    virtual TiValue::wallet::WalletTransactionEntry destroy_contract(const std::string& contract_address, const std::string& destroyer_name, const std::string& asset_symbol, const fc::optional<double>& exec_limit) = 0;
    /**
     ...
     * @return asset_array
     */
    virtual std::vector<TiValue::blockchain::Asset> destroy_contract_testing(const std::string& contract_address, const std::string& destroyer_name) = 0;
    /**
     ...
     * @return transaction_entry
     */
    virtual TiValue::wallet::WalletTransactionEntry call_contract(const std::string& contract, const std::string& caller_name, const std::string& function_name, const std::string& params, const std::string& asset_symbol, const fc::optional<double>& call_limit) = 0;
    /**
     ...
     */
    virtual TiValue::blockchain::ContractEntryPrintable get_contract_info(const std::string& contract) = 0;
    /**
     ...
     */
    virtual std::vector<TiValue::blockchain::BalanceEntry> get_contract_balance(const std::string& contract) = 0;
    /**
     * call contract function by contract name or contract address on local endpoint, and do not spread it on P2P
     * network.
     *
     * @param contract contract name or contract address need to be called (string, required)
     * @param caller_name caller name (string, required)
     ...
     * @return asset_array
     */
    virtual std::vector<TiValue::blockchain::Asset> call_contract_testing(const std::string& contract, const std::string& caller_name, const std::string& function_name, const std::string& params) = 0;
    /**
     ...
     * @return contract_entry_printable
     */
    virtual TiValue::blockchain::ContractEntryPrintable load_contract_to_file(const std::string& contract, const fc::path& file) = 0;
    /**
     ...
     * @return transaction_id
     */
    virtual TiValue::blockchain::TransactionIdType get_result_trx_id(const TiValue::blockchain::TransactionIdType& request_id) = 0;
    /**
     ...
     * @return transaction_id
     */
    virtual TiValue::blockchain::TransactionIdType get_request_trx_id(const TiValue::blockchain::TransactionIdType& request_id) = 0;
    /**
     ...
     * @return transaction_entry
     */
    virtual TiValue::wallet::WalletTransactionEntry sandbox_call_contract(const std::string& contract, const std::string& caller_name, const std::string& function_name, const std::string& params, const std::string& cost_asset, const fc::optional<double>& callLimit) = 0;
    /**
     ...
     * @return transaction_entry
     */
    virtual TiValue::wallet::WalletTransactionEntry sandbox_upgrade_contract(const std::string& contract_address, const std::string& upgrader_name, const std::string& new_contract_name, const TiValue::blockchain::Imessage& new_contract_desc, const std::string& asset_symbol, const fc::optional<double>& exec_limit) = 0;
    /**
     * in sandbox state: upgrade temporary contract to permanent contract.
     *
     * @param contract_address contract address need to upgrade (string, required)
     ...
     * @return asset_array
     */
    virtual std::vector<TiValue::blockchain::Asset> sandbox_upgrade_contract_testing(const std::string& contract_address, const std::string& upgrader_name, const std::string& new_contract_name, const TiValue::blockchain::Imessage& new_contract_desc) = 0;
    /**
     ...
     * @return transaction_entry
     */
    virtual TiValue::wallet::WalletTransactionEntry sandbox_destroy_contract(const std::string& contract_address, const std::string& destroyer_name, const std::string& asset_symbol, const fc::optional<double>& exec_limit) = 0;
    /**
     ...
     * @return asset_array
     */
    virtual std::vector<TiValue::blockchain::Asset> sandbox_destroy_contract_testing(const std::string& contract_address, const std::string& destroyer_name) = 0;
    /**
     ...
     * @return contract_entry_printable
     */
    virtual TiValue::blockchain::ContractEntryPrintable sandbox_get_contract_info(const std::string& contract) = 0;
    /**
     * in sandbox state: get contract balance entry and margin balance entry by contract name or contract address.
     *
     * @param contract contract name or contract address (string, required)
     *
     * @return balance_entry_list
     */
    virtual std::vector<TiValue::blockchain::BalanceEntry> sandbox_get_contract_balance(const std::string& contract) = 0;
    /**
     ...
     * @return transaction_entry
     */
    virtual TiValue::wallet::WalletTransactionEntry sandbox_transfer_to_contract(double amount_to_transfer, const std::string& asset_symbol, const std::string& from_account_name, const std::string& to_contract, double amount_for_exec) = 0;
    /**
     ...
     * @return account_balance_summary_type
     */
    virtual TiValue::wallet::AccountBalanceSummaryType sandbox_account_balance(const std::string& account_name = fc::json::from_string("\"\"").as<std::string>()) = 0;
    /**
     ...
     * @return contract_entry_printable
     */
    virtual TiValue::blockchain::ContractEntryPrintable sandbox_load_contract_to_file(const std::string& contract, const fc::path& file) = 0;
    /**
     ...
     * @return asset_array
     */
    virtual std::vector<TiValue::blockchain::Asset> sandbox_register_contract_testing(const std::string& owner, const fc::path& codefile) = 0;
    /**
     * in sandbox call contract function by contract name or contract address on local endpoint, and do not spread it
     * on P2P network.
     *
     * @param contract contract name or contract address need to be called (string, required)
     * @param caller_name caller name (string, required)
     ...
     * @return asset_array
     */
    virtual std::vector<TiValue::blockchain::Asset> sandbox_call_contract_testing(const std::string& contract, const std::string& caller_name, const std::string& function_name, const std::string& params) = 0;
    /**
     * in sandbox Do a simple transfer to a contract (name or address) on local endpoint, and do not spread it on P2P
     * network.
     *
     * @param amount_to_transfer the amount of shares to transfer (real_amount, required)
     * @param asset_symbol the asset to transfer (asset_symbol, required)
     ...
     * @return asset_array
     */
    virtual std::vector<TiValue::blockchain::Asset> sandbox_transfer_to_contract_testing(double amount_to_transfer, const std::string& asset_symbol, const std::string& from_account_name, const std::string& to_contract) = 0;
    /**
     ...
     */
    virtual vector<TiValue::blockchain::SandboxAccountInfo> sandbox_list_my_addresses(const std::string& account_name = fc::json::from_string("\"\"").as<std::string>()) = 0;
    /**
     ...
     * @return string
     */
    virtual std::string get_contract_registered_in_transaction(const TiValue::blockchain::TransactionIdType& trx_id) = 0;
    /**
     ...
     * @return transaction_id
     */
    virtual TiValue::blockchain::TransactionIdType get_transaction_id_contract_registered(const std::string& contract_id) = 0;
    /**
     ...
     */
    virtual TiValue::blockchain::CodePrintAble get_contract_info_from_gpc_file(const fc::path& file) = 0;
    /**
     ...
     * @return string
     */
    virtual std::string add_script(const fc::path& filename, const TiValue::blockchain::Imessage& description) = 0;
    /**
     ...
     */
    virtual TiValue::wallet::ScriptEntryPrintable get_script_info(const std::string& scriptid) = 0;
    /**
     * List all scripts in database .
     *
     * @return scriptentry_printable_list
     */
    virtual std::vector<TiValue::wallet::ScriptEntryPrintable> list_scripts() = 0;
    /**
     ...
     * set local node id.
     *
     * @param node_id id of this node (string, required)
     */
    virtual void wallet_set_node_id(const std::string& node_id) = 0;
    /**
     * set local node id.
     *
     * @return file_id_list
     */
    virtual std::vector<std::string> blockchain_list_file_saved() = 0;
    /**
