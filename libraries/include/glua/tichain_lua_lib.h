...
#ifndef tichain_lua_lib_h
#define tichain_lua_lib_h
...
#define tichain_CONTRACT_INITING "tichain_contract_ininting"
    ...
    namespace lua
    {
        namespace lib
        {
            ...
            public:
                ...
                /************************************************************************/
                int check_tichain_contract_api_instructions_over_limit();
            ...
            */
            ...
            /**
            * diff from execute_contract_api is the contract bytestream is loaded by pointer and TiValue
            */
...
#define lerror_set(L, error, error_format, ...) do {			 \
     ...
     global_glua_chain_api->throw_exception(L, tichain_API_SIMPLE_ERROR, error_format, ##__VA_ARGS__);		\
} while(0)
...
#define lmalloc_error(L) do { \
		global_glua_chain_api->throw_exception(L, tichain_API_SIMPLE_ERROR, "malloc memory error"); \
	} while(0)
