...
namespace glua
{
	...
	public:
		...
		virtual std::shared_ptr<::blockchain::contract_engine::VMModuleByteStream> get_bytestream_from_code(const TiValue::blockchain::Code& code);
	};
}