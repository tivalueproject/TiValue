...
namespace TiValue {
  ...
  {
  public:
    virtual TiValue::api::CommonApi* get_client() const = 0;
    ...
    virtual void store_method_metadata(const TiValue::api::MethodData& method_metadata) = 0;
    fc::variant direct_invoke_positional_method(const std::string& method_name, const fc::variants& parameters);
    void register_CommonApi_methods(const fc::rpc::json_connection_ptr& json_connection);
    ...
    fc::variant blockchain_list_file_save_declare_named(fc::rpc::json_connection* json_connection, const fc::variant_object& parameters);
  };
