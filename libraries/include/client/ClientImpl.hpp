...
namespace TiValue {
    namespace client {
        ...
        namespace detail {
            ...
            {
            public:
                typedef TiValue::db::LevelMap<fc::time_point, fc::exception> ExceptionLeveldbType;
            private:
            ...
            public:
                void open(const fc::path& filename)
                {
                    ...
                    catch (const TiValue::db::level_map_open_failure&)
                    {
            ...
            class ClientImpl : public TiValue::net::NodeDelegate,
                public TiValue::api::CommonApi
            {
            public:
                ...
                ClientImpl(TiValue::client::Client* self, const std::string& user_agent) :
                    _self(self),
                    ...
                    _blockchain_synopsis_size_limit((unsigned)(log2(TIV_BLOCKCHAIN_BLOCKS_PER_YEAR * 20))),
                    _debug_last_wait_block(0)
                {
                    try
                    {
                        if (TiValue::lua::api::global_glua_chain_api == nullptr)
                            TiValue::lua::api::global_glua_chain_api = new TiValue::lua::api::GluaChainApi;
                ...
                */
				...
				TiValue::blockchain::TransactionIdType network_broadcast_transactions(const std::vector<TiValue::blockchain::SignedTransaction>& transactions_to_broadcast);
                ...
                // @{
				virtual bool has_item(const TiValue::net::ItemId& id) override;
				fc::time_point_sec handle_ntp_time(bool need_update)override;
                virtual bool handle_message(const TiValue::net::Message&, bool sync_mode) override;
                virtual std::vector<TiValue::net::ItemHashType> get_item_ids(uint32_t item_type,
                    const vector<TiValue::net::ItemHashType>& blockchain_synopsis,
                    uint32_t& remaining_item_count,
                    uint32_t limit = 2000) override;
                virtual TiValue::net::Message get_item(const TiValue::net::ItemId& id) override;
                virtual fc::sha256 get_chain_id() const override
                {
                    FC_ASSERT(_chain_db != nullptr);
                    return _chain_db->get_chain_id();
                }
                virtual std::vector<TiValue::net::ItemHashType> get_blockchain_synopsis(uint32_t item_type,
                ...
                virtual uint32_t get_block_number(const TiValue::net::ItemHashType& block_id) override;
                virtual fc::time_point_sec get_block_time(const TiValue::net::ItemHashType& block_id) override;
                virtual fc::time_point_sec get_blockchain_now() override;
                virtual TiValue::net::ItemHashType get_head_block_id() const override;
                ...
                TiValue::client::Client*                                    _self;
                std::string                                             _user_agent;
                TiValue::cli::Cli*                                          _cli = nullptr;
                ...
                TiValue::rpc::RpcServerPtr                                _rpc_server = nullptr;
                std::unique_ptr<TiValue::net::ChainServer>                 _chain_server = nullptr;
                std::unique_ptr<TiValue::net::UpnpService>                 _upnp_service = nullptr;
                ...
                //  std::shared_ptr<TiValue::mail::server>                      _mail_server = nullptr;
                // std::shared_ptr<TiValue::mail::client>                      _mail_client = nullptr;
                ...
                TiValue::net::NodePtr                                      _p2p_node = nullptr;
                bool                                                    _simulated_network = false;

                TvGntpNotifierPtr                                   _notifier;
                ...
                // include all of the method overrides generated by the tiv_api_generator
...
#include <rpc_stubs/CommonApiOverrides.ipp>//include auto-generated RPC API declarations
				// include auto-generated RPC API declarations
            };
