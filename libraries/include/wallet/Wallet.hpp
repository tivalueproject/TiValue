    ...
    namespace wallet {
        ...
        public:
            ...
            */
            ...
            void					set_last_scanned_block_number_for_tiv(uint32_t block_num);
            /**
            ...
            */
            ...
            uint32_t				get_last_scanned_block_number_for_tiv()const;
           ...
           */
            ...
            *
            * @param wif_key A private key in TiValue wallet import format
            ...
            * @param amount_to_transfer_symbol the asset to transfer like TV 
            ...
            * @param sub_account centralized system address
            *
            * @return WalletTransactionEntry
            */
            ...
            std::vector<TiValue::blockchain::Asset> transfer_asset_to_contract_testing(
                double real_amount_to_transfer,
                const string& amount_to_transfer_symbol,
                const string& from_account_name,
                const Address& to_contract_address,
			...
			std::vector<TiValue::blockchain::Asset> upgrade_contract_testing(
				const Address& contract_id,
				const string& upgrader_name,
				const string& contract_name,
				const string& contract_desc,
			...
			std::vector<TiValue::blockchain::Asset> destroy_contract_testing(
				const Address& contract_id,
				const string& destroyer_name,
				bool sign = true
				);
            ...
            */
            WalletTransactionEntry register_account(
                ...
                TiValue::blockchain::AccountType new_account_type,
                bool sign
                );
            /**
            ...
            */
            DelegatePaySalary query_delegate_salary(
                const string& delegate_name);
            std::map<std::string, TiValue::blockchain::DelegatePaySalary> query_delegate_salarys();
            ...
            * @return string
            */
            PrettyTransaction				    to_pretty_trx(const TiValue::blockchain::TransactionEntry& trx_entry, const std::string addr_for_fee) const;


            PrettyContractTransaction           to_pretty_contract_trx(const TiValue::blockchain::TransactionEntry& trx_entry) const;
            ...
            * @return PublicKeyType
            */
            fc::variant login_finish(const PublicKeyType& server_key, const PublicKeyType& client_key, const fc::ecc::compact_signature& client_signature);
            ...
            std::vector<TiValue::blockchain::Asset> register_contract_testing(const string& owner, const fc::path codefile);
            ...
            std::vector<TiValue::blockchain::Asset> call_contract_testing(const string caller, const ContractIdType contract, const string method, const string& arguments);
...
<<<<<<< HEAD
			...
			TiValue::wallet::WalletTransactionEntry declare_piece_saved(const std::string& file_id, const std::string& piece_id, const std::string& storer);
=======
            std::vector<std::string> get_events_bound(const std::string& script_id);
...
FC_REFLECT_ENUM(TiValue::wallet::AccountKeyType,
    (owner_key)
    (active_key)
    (signing_key)
    )
