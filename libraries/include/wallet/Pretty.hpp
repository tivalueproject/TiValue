...
namespace TiValue {
    namespace wallet {
        ...
        struct PrettyTransaction
        {
            ...
            // transaction type
            fc::enum_type<TiValue::blockchain::TransactionType, uint32_t>   trx_type = TiValue::blockchain::TransactionType::normal_transaction;
        ...
        struct PrettyContractTransaction
        {
            ...
            uint32_t                block_num = 0;
            uint32_t                block_position = 0;
            fc::enum_type<TiValue::blockchain::TransactionType, uint32_t>   trx_type;
            bool is_completed;
...
FC_REFLECT(TiValue::wallet::PublicKeySummary, (hex)(native_pubkey)(native_address)(pts_normal_address)(pts_compressed_address)(btc_normal_address)(btc_compressed_address))

FC_REFLECT(TiValue::wallet::VoteSummary, (utilization)(negative_utilization)(up_to_date_with_recommendation))

FC_REFLECT(TiValue::wallet::PrettyLedgerEntry,
(from_account)
(from_account_name)
(to_account)
(to_account_name)
...
FC_REFLECT(TiValue::wallet::PrettyTransaction,
(is_virtual)
(is_confirmed)
(is_market)
(is_market_cancel)
...
FC_REFLECT(TiValue::wallet::PrettyContractLedgerEntry,
(from_account)
(from_account_name)
(to_account)
(to_account_name)
...
FC_REFLECT(TiValue::wallet::PrettyContractTransaction,
(result_trx_id)
(orig_trx_id)
(block_num)
(block_position)
...
FC_REFLECT(TiValue::wallet::PrettyReserveBalance,
(balance_id)
(sharedrop_address)
(start_time)
(duration)
...
FC_REFLECT(TiValue::wallet::EscrowSummary,
