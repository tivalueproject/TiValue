...
namespace TiValue {
    namespace rpc {
        ...
        /**
        *  @class rpc_server
        *  @brief provides a json-rpc interface to the TiValue client
        */
        class RpcServer
        {
        public:
            RpcServer(TiValue::client::Client* client);
            virtual ~RpcServer();

            bool        configure_rpc(const TiValue::client::RpcServerConfig& cfg);
            bool        configure_http(const TiValue::client::RpcServerConfig& cfg);
            bool        configure_encrypted_rpc(const TiValue::client::RpcServerConfig& cfg);
            ...
            const TiValue::api::MethodData& get_method_data(const std::string& method_name);
            std::vector<TiValue::api::MethodData> get_all_method_data() const;
        ...
        protected:
            friend class TiValue::rpc::detail::RpcServerImpl;

            void validate_method_data(TiValue::api::MethodData method);
            void register_method(TiValue::api::MethodData method);
