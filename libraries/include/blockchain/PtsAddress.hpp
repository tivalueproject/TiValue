...
{
    template<>
    struct hash < TiValue::blockchain::PtsAddress >
    {
    public:
        size_t operator()(const TiValue::blockchain::PtsAddress &a) const
        {
            size_t s;
...
FC_REFLECT(TiValue::blockchain::PtsAddress, (addr))

namespace fc
{
    void to_variant(const TiValue::blockchain::PtsAddress& var, fc::variant& vo);
    void from_variant(const fc::variant& var, TiValue::blockchain::PtsAddress& vo);
}
