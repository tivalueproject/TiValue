...
FC_REFLECT_ENUM(TiValue::blockchain::AccountType,
    (titan_account)
    (public_account)
    (multisig_account)
    )
    FC_REFLECT(TiValue::blockchain::MultisigMetaInfo,
    (required)
    (owners)
    )
    FC_REFLECT(TiValue::blockchain::AccountMetaInfo,
    (type)
    (data)
    )
    FC_REFLECT(TiValue::blockchain::DelegateStats,
    (votes_for)
    (pay_rate)
    (signing_key_history)
    ...
    FC_REFLECT(TiValue::blockchain::VoteDel,
    (votes)
    (delegate_id)
    )
    FC_REFLECT(TiValue::blockchain::AccountEntry,
    (id)
    (name)
    (public_data)
    (owner_key)
    ...
    FC_REFLECT(TiValue::blockchain::DelegatePaySalary, (total_balance)(pay_balance))