...
FC_REFLECT(TiValue::blockchain::SnapshotEntry, (original_address)(original_balance))
FC_REFLECT(TiValue::blockchain::BalanceEntry, (condition)(balance)(restricted_owner)(snapshot_info)(deposit_date)(last_update)(meta_data))
