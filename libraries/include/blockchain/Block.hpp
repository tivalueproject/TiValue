...
FC_REFLECT(TiValue::blockchain::BlockHeader,
    (previous)(block_num)(timestamp)(transaction_digest)(next_secret_hash)(previous_secret))
    FC_REFLECT_DERIVED(TiValue::blockchain::SignedBlockHeader, (TiValue::blockchain::BlockHeader), (delegate_signature))
    FC_REFLECT_DERIVED(TiValue::blockchain::FullBlock, (TiValue::blockchain::SignedBlockHeader), (user_transactions))
    FC_REFLECT_DERIVED(TiValue::blockchain::DigestBlock, (TiValue::blockchain::SignedBlockHeader), (user_transaction_ids))
