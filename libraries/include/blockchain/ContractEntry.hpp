...
namespace TiValue {
    namespace blockchain{
        ...
        struct Code
        {
            ...
            std::map<std::string, fc::enum_type<fc::unsigned_int, TiValue::blockchain::StorageValueTypes>> storage_properties;
...
FC_REFLECT_ENUM(TiValue::blockchain::ContractApiType,
    (chain)
    (offline)
    (event)
    )

    FC_REFLECT_ENUM(TiValue::blockchain::ContractState,
    (valid)
    (deleted)
    )

    FC_REFLECT_ENUM(TiValue::blockchain::ContractLevel,
    (temp)
    (forever)
    )


    FC_REFLECT(TiValue::blockchain::Code,
    (abi)
    (offline_abi)
    (events)
    (storage_properties)
    ...
    FC_REFLECT(TiValue::blockchain::CodePrintAble,
    (abi)
    (offline_abi)
    (events)
    ...
    FC_REFLECT(TiValue::blockchain::ContractEntry,
    (contract_name)
    (id)
    (level)
    (owner)
    ...
    FC_REFLECT(TiValue::blockchain::ContractEntryPrintable,
    (contract_name)
    (id)
    (level)
    (owner)
    ...
    FC_REFLECT(TiValue::blockchain::ContractStorageEntry, (id)(contract_storages))
	FC_REFLECT(TiValue::blockchain::ResultTIdEntry, (res))
	FC_REFLECT(TiValue::blockchain::RequestIdEntry, (req))
	FC_REFLECT(TiValue::blockchain::ContractTrxEntry, (trx_id))
	FC_REFLECT(TiValue::blockchain::ContractinTrxEntry, (contract_id))
