...
FC_REFLECT_ENUM(TiValue::blockchain::StorageValueTypes,
    (storage_value_null)
    (storage_value_int)
    ...
    FC_REFLECT(TiValue::blockchain::StorageDataType,
    (storage_type)
    (storage_data)
    )

    FC_REFLECT(TiValue::blockchain::StorageNullType,
    (raw_storage)
    )

    FC_REFLECT(TiValue::blockchain::StorageIntType,
    (raw_storage)
    )

    FC_REFLECT(TiValue::blockchain::StorageBoolType,
    (raw_storage)
    )

    FC_REFLECT(TiValue::blockchain::StorageNumberType,
    (raw_storage)
    )

    FC_REFLECT(TiValue::blockchain::StorageStringType,
    (raw_storage)
    )

    FC_REFLECT(TiValue::blockchain::StorageIntTableType,
    (raw_storage_map)
    )

    FC_REFLECT(TiValue::blockchain::StorageBoolTableType,
    (raw_storage_map)
    )

    FC_REFLECT(TiValue::blockchain::StorageNumberTableType,
    (raw_storage_map)
    )

    FC_REFLECT(TiValue::blockchain::StorageStringTableType,
    (raw_storage_map)
    )

    FC_REFLECT(TiValue::blockchain::StorageIntArrayType,
    (raw_storage_map)
    )

    FC_REFLECT(TiValue::blockchain::StorageBoolArrayType,
    (raw_storage_map)
    )

    FC_REFLECT(TiValue::blockchain::StorageNumberArrayType,
    (raw_storage_map)
    )

    FC_REFLECT(TiValue::blockchain::StorageStringArrayType,
    (raw_storage_map)
    )
