...
FC_REFLECT_ENUM(TiValue::blockchain::DepositContractType, (deposit_contract_normal)(deposit_contract_margin))
FC_REFLECT(TiValue::blockchain::DepositContractOperation, (amount)(condition))
FC_REFLECT(TiValue::blockchain::WithdrawOperation, (balance_id)(amount)(claim_input_data))
FC_REFLECT(TiValue::blockchain::DepositOperation, (amount)(condition))
FC_REFLECT(TiValue::blockchain::WithdrawContractOperation, (balance_id)(amount)(contract))
FC_REFLECT(TiValue::blockchain::BalancesWithdrawOperation, (balances))
FC_REFLECT(TiValue::blockchain::ReleaseEscrowOperation, (escrow_id)(released_by)(amount_to_receiver)(amount_to_sender))
FC_REFLECT(TiValue::blockchain::UpdateBalanceVoteOperation, (balance_id)(new_restricted_owner)(new_slate))
