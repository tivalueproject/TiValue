...
FC_REFLECT(TiValue::blockchain::RegisterAccountOperation, (name)(public_data)(owner_key)(active_key)(delegate_pay_rate)(meta_data))
FC_REFLECT(TiValue::blockchain::UpdateAccountOperation, (account_id)(public_data)(active_key)(delegate_pay_rate))
FC_REFLECT(TiValue::blockchain::WithdrawPayOperation, (amount)(account_id))
FC_REFLECT(TiValue::blockchain::UpdateSigningKeyOperation, (account_id)(signing_key))
