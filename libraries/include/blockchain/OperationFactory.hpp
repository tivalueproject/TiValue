    ...
    namespace blockchain {
        ...
        public:
            ...
            public:
                ...
                virtual void to_variant(const TiValue::blockchain::Operation& in, fc::variant& out) = 0;
                virtual void from_variant(const fc::variant& in, TiValue::blockchain::Operation& out) = 0;
            ...
            {
            public:
                virtual void to_variant(const TiValue::blockchain::Operation& in, fc::variant& output)
                {
                    try {
                ...
                virtual void from_variant(const fc::variant& in, TiValue::blockchain::Operation& output)
                {
                    try {
            ...
            void evaluate(TransactionEvaluationState& eval_state, const Operation& op)
            {
                ...
                if (itr == _converters.end())
                    FC_THROW_EXCEPTION(TiValue::blockchain::unsupported_chain_operation, "", ("op", op));
                itr->second->evaluate(eval_state, op);
            }

            /// defined in operations.cpp
            void to_variant(const TiValue::blockchain::Operation& in, fc::variant& output);
            /// defined in operations.cpp
            void from_variant(const fc::variant& in, TiValue::blockchain::Operation& output);
