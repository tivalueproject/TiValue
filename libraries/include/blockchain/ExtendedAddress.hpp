...
FC_REFLECT(TiValue::blockchain::ExtendedPublicKey, (pub_key)(chain_code))
FC_REFLECT(TiValue::blockchain::ExtendedPrivateKey, (priv_key)(chain_code))
FC_REFLECT(TiValue::blockchain::ExtendedAddress, (addr))

namespace fc
{
    void to_variant(const TiValue::blockchain::ExtendedAddress& var, fc::variant& vo);
...
{
    template<>
    struct hash < TiValue::blockchain::ExtendedAddress >
    {
    public:
        size_t operator()(const TiValue::blockchain::ExtendedAddress &a) const
        {
            size_t s;
            fc::sha1::encoder enc;
            fc::raw::pack(enc, a);
