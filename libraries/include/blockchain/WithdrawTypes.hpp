...
namespace TiValue {
    namespace blockchain {
        ...
        struct MemoData
        {
             ...
             */
            fc::array<char, TIV_BLOCKCHAIN_MAX_MEMO_SIZE>     message;
        ...
        struct ExtendedMemoData
        {
            ...
            fc::array<char, TIV_BLOCKCHAIN_MAX_MEMO_SIZE>      message;
            fc::enum_type<uint8_t, MemoFlagsEnum>            memo_flags;
            fc::array<char, TIV_BLOCKCHAIN_EXTENDED_MEMO_SIZE> extra_memo;
        };
...
namespace fc {
    void to_variant(const TiValue::blockchain::WithdrawCondition& var, variant& vo);
    void from_variant(const variant& var, TiValue::blockchain::WithdrawCondition& vo);
    void to_variant(const TiValue::blockchain::MemoData& var, variant& vo);
    void from_variant(const variant& var, TiValue::blockchain::MemoData& vo);
}

FC_REFLECT_ENUM(TiValue::blockchain::WithdrawConditionTypes,
    (withdraw_null_type)
    (withdraw_signature_type)
    (withdraw_multisig_type)
    (withdraw_escrow_type)
    )
    FC_REFLECT_ENUM(TiValue::blockchain::WithdrawBalanceTypes,
    (withdraw_common_type)
    (withdraw_contract_type)
    (withdraw_margin_type)
    )
    FC_REFLECT(TiValue::blockchain::WithdrawCondition,
    (asset_id)
    (slate_id)
    (type)
    (balance_type)
    ...
    FC_REFLECT(TiValue::blockchain::TransferMemo,
    (one_time_key)
    (encrypted_memo_data)
    )
    FC_REFLECT_ENUM(TiValue::blockchain::MemoFlagsEnum,
    (from_memo)
    (to_memo)
    )
    FC_REFLECT(TiValue::blockchain::MemoData,
    (from)
    (from_signature)
    (message)
    (memo_flags)
    ...
    FC_REFLECT(TiValue::blockchain::ExtendedMemoData,
    (from)
    (from_signature)
    (message)
    (memo_flags)
    ...
    FC_REFLECT_DERIVED(TiValue::blockchain::MemoStatus,
    (TiValue::blockchain::MemoData),
    (has_valid_signature)
    (owner_private_key)
    )
    FC_REFLECT(TiValue::blockchain::WithdrawWithSignature,
    (owner)
    (memo)
    )

    FC_REFLECT(TiValue::blockchain::WithdrawWithMultisig,
    (required)
    (owners)
    (memo)
    )
    FC_REFLECT(TiValue::blockchain::withdraw_with_escrow,
    (sender)
    (receiver)
    (escrow)
    (agreement_digest)
