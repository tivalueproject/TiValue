...
FC_REFLECT(TiValue::blockchain::CreateAssetOperation,
    (symbol)
    (name)
    (description)
    (public_data)
    ...
    FC_REFLECT(TiValue::blockchain::UpdateAssetOperation,
    (asset_id)
    (name)
    (description)
    (public_data)
    ...
    FC_REFLECT_DERIVED(TiValue::blockchain::UpdateAssetExtOperation,
    (TiValue::blockchain::UpdateAssetOperation),
    (flags)
    (issuer_permissions)
    (issuer_account_id)
    (transaction_fee)
    ...
    FC_REFLECT(TiValue::blockchain::IssueAssetOperation,
    (amount)
    )
