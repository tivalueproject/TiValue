...
namespace fc
{
    void to_variant(const TiValue::blockchain::PublicKeyType& var, fc::variant& vo);
    void from_variant(const fc::variant& var, TiValue::blockchain::PublicKeyType& vo);
}

#include <fc/reflect/reflect.hpp>
FC_REFLECT(TiValue::blockchain::PublicKeyType, (key_data))
FC_REFLECT(TiValue::blockchain::PublicKeyType::BinaryKey, (data)(check));
FC_REFLECT_ENUM(TiValue::blockchain::BlockchainSecurityState::alert_level_enum, (green)(yellow)(red)(grey));
FC_REFLECT(TiValue::blockchain::BlockchainSecurityState, (alert_level)(estimated_confirmation_seconds)(participation_rate))
