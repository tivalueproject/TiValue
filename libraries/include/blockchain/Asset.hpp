...
namespace TiValue {
    namespace blockchain {
        ...
        struct Price
        {
            ...
            fc::uint128_t ratio; // This is a DECIMAL FRACTION with denominator equal to TIV_PRICE_PRECISIONI
         ...
         *  denominator.  Therefore  TiValue/usd and  usd/TiValue will
         *  always result in a price measured in usd/TiValue because
         ...
         *
         *  ie:  p = 3 usd/TiValue & a = 4 TiValue then result = 12 usd
         *  ie:  p = 3 usd/TiValue & a = 4 usd then result = 1.333 TiValue
         */
...
namespace fc
{
    //  void to_variant( const TiValue::blockchain::asset& var,  variant& vo );
    //  void from_variant( const variant& var,  TiValue::blockchain::asset& vo );
    void to_variant(const TiValue::blockchain::Price& var, variant& vo);
    void from_variant(const variant& var, TiValue::blockchain::Price& vo);
}

#include <fc/reflect/reflect.hpp>
FC_REFLECT(TiValue::blockchain::Price, (ratio)(quote_asset_id)(base_asset_id));
FC_REFLECT(TiValue::blockchain::Asset, (amount)(asset_id));
