...
FC_REFLECT(TiValue::blockchain::UpgradeContractOperation, (id)(name)(desc)(exec_limit)(transaction_fee)(balances))
FC_REFLECT(TiValue::blockchain::DestroyContractOperation, (id)(exec_limit)(transaction_fee)(balances))
FC_REFLECT(TiValue::blockchain::OnDestroyOperation, (id)(amount))
FC_REFLECT(TiValue::blockchain::OnUpgradeOperation, (id)(name)(desc))
FC_REFLECT(TiValue::blockchain::OnCallSuccessOperation, )
FC_REFLECT(TiValue::blockchain::RegisterContractOperation, (contract_code)(initcost)(transaction_fee)(balances)(owner)(register_time))
FC_REFLECT(TiValue::blockchain::CallContractOperation, (caller)(balances)(contract)(costlimit)(transaction_fee)(method)(args))
FC_REFLECT(TiValue::blockchain::ContractInfoOperation, (contract_id)(owner)(code)(register_time))
FC_REFLECT(TiValue::blockchain::TransferContractOperation, (from)(costlimit)(transaction_fee)(transfer_amount)(balances)(contract_id))
