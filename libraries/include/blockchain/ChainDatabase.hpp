    ...
    namespace blockchain {
        ...
        public:
            ...
            */
			...
			bool				store_account_entries_for_sandbox(const vector<TiValue::wallet::WalletAccountEntry>& vec_account_entry);
            /**
...
FC_REFLECT(TiValue::blockchain::BlockForkData, (next_blocks)(is_linked)(is_valid)(invalid_reason)(is_included)(is_known))
FC_REFLECT(TiValue::blockchain::ForkEntry, (block_id)(signing_delegate)(transaction_count)(latency)(size)(timestamp)(is_valid)(invalid_reason)(is_current_fork))
