...
namespace TiValue {
    namespace net {
        ...
        public:
             ...
             */
            virtual std::vector<ItemHashType> get_blockchain_synopsis(uint32_t item_type, const TiValue::net::ItemHashType& reference_point = TiValue::net::ItemHashType(), uint32_t number_of_blocks_after_reference_point = 0) = 0;
...
FC_REFLECT(TiValue::net::MessagePropagationData, (received_time)(validated_time)(originating_peer));
