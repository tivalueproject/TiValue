...
namespace TiValue {
    namespace net
    {
        ...
        public:
            ...
            fc::optional<std::string> tichain_git_revision_sha;
            fc::optional<fc::time_point_sec> tichain_git_revision_unix_timestamp;
...
FC_REFLECT_ENUM(TiValue::net::PeerConnection::OurConnectionState, (disconnected)
    (just_connected)
    (connection_accepted)
    (connection_rejected))
    FC_REFLECT_ENUM(TiValue::net::PeerConnection::TheirConnectionState, (disconnected)
    (just_connected)
    (connection_accepted)
    (connection_rejected))
    FC_REFLECT_ENUM(TiValue::net::PeerConnection::ConnectionNegotiationStatus, (disconnected)
    (connecting)
    (connected)
    (accepting)
    (accepted)
