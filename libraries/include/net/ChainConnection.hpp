...
namespace TiValue {
    namespace net {
        ...
        public:
            ...
            TiValue::blockchain::BlockIdType get_last_block_id()const;
            void                           set_last_block_id(const TiValue::blockchain::BlockIdType& t);

            void exec_sync_loop();
            void set_database(TiValue::blockchain::ChainDatabase*);
