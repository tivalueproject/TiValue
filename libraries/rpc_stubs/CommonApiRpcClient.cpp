...
TiValue::blockchain::Asset CommonApiRpcClient::blockchain_calculate_supply(const std::string& asset) const
{
  fc::variant result = get_json_connection()->async_call("blockchain_calculate_supply", std::vector<fc::variant>{fc::variant(asset)}).wait();
  return result.as<TiValue::blockchain::Asset>();
}
...
TiValue::blockchain::BlockchainSecurityState CommonApiRpcClient::blockchain_get_security_state() const
{
  fc::variant result = get_json_connection()->async_call("blockchain_get_security_state", std::vector<fc::variant>{}).wait();
  return result.as<TiValue::blockchain::BlockchainSecurityState>();
}
std::vector<TiValue::blockchain::AccountEntry> CommonApiRpcClient::blockchain_list_accounts(const std::string& first_account_name /* = fc::json::from_string("\"\"").as<std::string>() */, uint32_t limit /* = fc::json::from_string("20").as<uint32_t>() */) const
{
  ...
  return result.as<std::vector<TiValue::blockchain::AccountEntry>>();
}
std::vector<TiValue::blockchain::AccountEntry> CommonApiRpcClient::blockchain_list_recently_updated_accounts() const
{
  fc::variant result = get_json_connection()->async_call("blockchain_list_recently_updated_accounts", std::vector<fc::variant>{}).wait();
  return result.as<std::vector<TiValue::blockchain::AccountEntry>>();
}
std::vector<TiValue::blockchain::AccountEntry> CommonApiRpcClient::blockchain_list_recently_registered_accounts() const
{
  fc::variant result = get_json_connection()->async_call("blockchain_list_recently_registered_accounts", std::vector<fc::variant>{}).wait();
  return result.as<std::vector<TiValue::blockchain::AccountEntry>>();
}
std::vector<TiValue::blockchain::AssetEntry> CommonApiRpcClient::blockchain_list_assets(const std::string& first_symbol /* = fc::json::from_string("\"\"").as<std::string>() */, uint32_t limit /* = fc::json::from_string("20").as<uint32_t>() */) const
{
  ...
  return result.as<std::vector<TiValue::blockchain::AssetEntry>>();
}
std::vector<std::pair<TiValue::blockchain::TransactionIdType, TiValue::blockchain::SignedTransaction>> CommonApiRpcClient::blockchain_list_pending_transactions() const
{
  fc::variant result = get_json_connection()->async_call("blockchain_list_pending_transactions", std::vector<fc::variant>{}).wait();
  return result.as<std::vector<std::pair<TiValue::blockchain::TransactionIdType, TiValue::blockchain::SignedTransaction>>>();
}
std::pair<TiValue::blockchain::TransactionIdType, TiValue::blockchain::TransactionEntry> CommonApiRpcClient::blockchain_get_transaction(const std::string& transaction_id_prefix, bool exact /* = fc::json::from_string("false").as<bool>() */) const
{
  ...
  return result.as<std::pair<TiValue::blockchain::TransactionIdType, TiValue::blockchain::TransactionEntry>>();
}
TiValue::wallet::PrettyTransaction CommonApiRpcClient::blockchain_get_pretty_transaction(const std::string& transaction_id_prefix, bool exact /* = fc::json::from_string("false").as<bool>() */) const
{
  ...
  return result.as<TiValue::wallet::PrettyTransaction>();
}
TiValue::wallet::PrettyContractTransaction CommonApiRpcClient::blockchain_get_pretty_contract_transaction(const std::string& transaction_id_prefix, bool exact /* = fc::json::from_string("false").as<bool>() */) const
{
  ...
  return result.as<TiValue::wallet::PrettyContractTransaction>();
}
fc::optional<TiValue::blockchain::BlockEntry> CommonApiRpcClient::blockchain_get_block(const std::string& block) const
{
  fc::variant result = get_json_connection()->async_call("blockchain_get_block", std::vector<fc::variant>{fc::variant(block)}).wait();
  return result.as<fc::optional<TiValue::blockchain::BlockEntry>>();
}
std::map<TiValue::blockchain::TransactionIdType, TiValue::blockchain::TransactionEntry> CommonApiRpcClient::blockchain_get_block_transactions(const std::string& block) const
{
  ...
  return result.as<std::map<TiValue::blockchain::TransactionIdType, TiValue::blockchain::TransactionEntry>>();
}
fc::optional<TiValue::blockchain::AccountEntry> CommonApiRpcClient::blockchain_get_account(const std::string& account) const
{
  fc::variant result = get_json_connection()->async_call("blockchain_get_account", std::vector<fc::variant>{fc::variant(account)}).wait();
  return result.as<fc::optional<TiValue::blockchain::AccountEntry>>();
}
std::map<TiValue::blockchain::AccountIdType, std::string> CommonApiRpcClient::blockchain_get_slate(const std::string& slate) const
{
  fc::variant result = get_json_connection()->async_call("blockchain_get_slate", std::vector<fc::variant>{fc::variant(slate)}).wait();
  return result.as<std::map<TiValue::blockchain::AccountIdType, std::string>>();
}
TiValue::blockchain::BalanceEntry CommonApiRpcClient::blockchain_get_balance(const TiValue::blockchain::Address& balance_id) const
{
  fc::variant result = get_json_connection()->async_call("blockchain_get_balance", std::vector<fc::variant>{fc::variant(balance_id)}).wait();
  return result.as<TiValue::blockchain::BalanceEntry>();
}
std::unordered_map<TiValue::blockchain::BalanceIdType, TiValue::blockchain::BalanceEntry> CommonApiRpcClient::blockchain_list_balances(const std::string& first_balance_id /* = fc::json::from_string("\"\"").as<std::string>() */, uint32_t limit /* = fc::json::from_string("20").as<uint32_t>() */) const
{
  ...
  return result.as<std::unordered_map<TiValue::blockchain::BalanceIdType, TiValue::blockchain::BalanceEntry>>();
}
std::unordered_map<TiValue::blockchain::BalanceIdType, TiValue::blockchain::BalanceEntry> CommonApiRpcClient::blockchain_list_address_balances(const std::string& addr, const fc::time_point& chanced_since /* = fc::json::from_string("\"1970-1-1T00:00:01\"").as<fc::time_point>() */) const
{
...
TiValue::wallet::AccountBalanceSummaryType CommonApiRpcClient::blockchain_get_account_public_balance(const std::string& account_name) const
{
  ...
  return result.as<TiValue::wallet::AccountBalanceSummaryType>();
}
std::unordered_map<TiValue::blockchain::BalanceIdType, TiValue::blockchain::BalanceEntry> CommonApiRpcClient::blockchain_list_key_balances(const TiValue::blockchain::PublicKeyType& key) const
{
  fc::variant result = get_json_connection()->async_call("blockchain_list_key_balances", std::vector<fc::variant>{fc::variant(key)}).wait();
  return result.as<std::unordered_map<TiValue::blockchain::BalanceIdType, TiValue::blockchain::BalanceEntry>>();
}
fc::optional<TiValue::blockchain::AssetEntry> CommonApiRpcClient::blockchain_get_asset(const std::string& asset) const
{
  fc::variant result = get_json_connection()->async_call("blockchain_get_asset", std::vector<fc::variant>{fc::variant(asset)}).wait();
  return result.as<fc::optional<TiValue::blockchain::AssetEntry>>();
}
std::vector<TiValue::blockchain::AccountEntry> CommonApiRpcClient::blockchain_list_active_delegates(uint32_t first /* = fc::json::from_string("0").as<uint32_t>() */, uint32_t count /* = fc::json::from_string("20").as<uint32_t>() */) const
{
...
std::vector<TiValue::blockchain::AccountEntry> CommonApiRpcClient::blockchain_list_delegates(uint32_t first /* = fc::json::from_string("0").as<uint32_t>() */, uint32_t count /* = fc::json::from_string("20").as<uint32_t>() */) const
{
...
std::vector<TiValue::blockchain::BlockEntry> CommonApiRpcClient::blockchain_list_blocks(uint32_t max_block_num /* = fc::json::from_string("-1").as<uint32_t>() */, uint32_t limit /* = fc::json::from_string("20").as<uint32_t>() */)
{
  ...
  return result.as<std::vector<TiValue::blockchain::BlockEntry>>();
}
...
std::string CommonApiRpcClient::blockchain_export_fork_graph(uint32_t start_block /* = fc::json::from_string("1").as<uint32_t>() */, uint32_t end_block /* = fc::json::from_string("-1").as<uint32_t>() */, const TiValue::blockchain::FilePath& filename /* = fc::json::from_string("\"\"").as<TiValue::blockchain::FilePath>() */) const
{
...
std::map<uint32_t, std::vector<TiValue::blockchain::ForkEntry>> CommonApiRpcClient::blockchain_list_forks() const
{
  fc::variant result = get_json_connection()->async_call("blockchain_list_forks", std::vector<fc::variant>{}).wait();
  return result.as<std::map<uint32_t, std::vector<TiValue::blockchain::ForkEntry>>>();
}
std::vector<TiValue::blockchain::SlotEntry> CommonApiRpcClient::blockchain_get_delegate_slot_entrys(const std::string& delegate_name, uint32_t limit /* = fc::json::from_string("\"10\"").as<uint32_t>() */) const
{
  ...
  return result.as<std::vector<TiValue::blockchain::SlotEntry>>();
}
...
TiValue::blockchain::Asset CommonApiRpcClient::blockchain_unclaimed_genesis() const
{
...
void CommonApiRpcClient::blockchain_broadcast_transaction(const TiValue::blockchain::SignedTransaction& trx)
{
...
TiValue::blockchain::TransactionIdType CommonApiRpcClient::blockchain_get_transaction_id(const TiValue::blockchain::SignedTransaction& transaction_to_broadcast) const
{
  ...
  return result.as<TiValue::blockchain::TransactionIdType>();
}
...
TiValue::blockchain::TransactionIdType CommonApiRpcClient::network_broadcast_transaction(const TiValue::blockchain::SignedTransaction& transaction_to_broadcast)
{
...
TiValue::net::MessagePropagationData CommonApiRpcClient::network_get_transaction_propagation_data(const TiValue::blockchain::TransactionIdType& transaction_id)
{
  ...
  return result.as<TiValue::net::MessagePropagationData>();
}
TiValue::net::MessagePropagationData CommonApiRpcClient::network_get_block_propagation_data(const TiValue::blockchain::BlockIdType& block_hash)
{
...
std::vector<TiValue::net::PotentialPeerEntry> CommonApiRpcClient::network_list_potential_peers() const
{
  fc::variant result = get_json_connection()->async_call("network_list_potential_peers", std::vector<fc::variant>{}).wait();
  return result.as<std::vector<TiValue::net::PotentialPeerEntry>>();
}
...
void CommonApiRpcClient::delegate_blacklist_add_transaction(const TiValue::blockchain::TransactionIdType& id)
{
...
void CommonApiRpcClient::delegate_blacklist_remove_transaction(const TiValue::blockchain::TransactionIdType& id)
{
...
void CommonApiRpcClient::delegate_blacklist_add_operation(const TiValue::blockchain::OperationTypeEnum& id)
{
...
void CommonApiRpcClient::delegate_blacklist_remove_operation(const TiValue::blockchain::OperationTypeEnum& id)
{
...
std::vector<TiValue::wallet::PrettyTransaction> CommonApiRpcClient::wallet_account_transaction_history(const std::string& account_name /* = fc::json::from_string("\"\"").as<std::string>() */, const std::string& asset_symbol /* = fc::json::from_string("\"\"").as<std::string>() */, int32_t limit /* = fc::json::from_string("0").as<int32_t>() */, uint32_t start_block_num /* = fc::json::from_string("0").as<uint32_t>() */, uint32_t end_block_num /* = fc::json::from_string("-1").as<uint32_t>() */) const
{
...
TiValue::wallet::AccountBalanceSummaryType CommonApiRpcClient::wallet_account_historic_balance(const fc::time_point& time, const std::string& account_name /* = fc::json::from_string("\"\"").as<std::string>() */) const
{
...
std::map<TiValue::blockchain::TransactionIdType, fc::exception> CommonApiRpcClient::wallet_get_pending_transaction_errors(const TiValue::blockchain::FilePath& filename /* = fc::json::from_string("\"\"").as<TiValue::blockchain::FilePath>() */) const
{
  ...
  return result.as<std::map<TiValue::blockchain::TransactionIdType, fc::exception>>();
}
...
TiValue::blockchain::Address CommonApiRpcClient::wallet_account_create(const std::string& account_name, const fc::variant& private_data /* = fc::json::from_string("null").as<fc::variant>() */)
{
  ...
  return result.as<TiValue::blockchain::Address>();
}
...
std::vector<TiValue::blockchain::AccountEntry> CommonApiRpcClient::wallet_get_all_approved_accounts(int8_t approval /* = fc::json::from_string("1").as<int8_t>() */)
{
...
TiValue::blockchain::SignedTransaction CommonApiRpcClient::create_transfer_transaction(const std::string& amount_to_transfer, const std::string& asset_symbol, const std::string& from_account_name, const std::string& to_address, const TiValue::blockchain::Imessage& memo_message /* = fc::json::from_string("\"\"").as<TiValue::blockchain::Imessage>() */, const TiValue::wallet::VoteStrategy& strategy /* = fc::json::from_string("\"vote_recommended\"").as<TiValue::wallet::VoteStrategy>() */)
{
  ...
  return result.as<TiValue::blockchain::SignedTransaction>();
}
...
TiValue::wallet::TransactionBuilder CommonApiRpcClient::wallet_withdraw_from_address(const std::string& amount, const std::string& symbol, const TiValue::blockchain::Address& from_address, const std::string& to, const TiValue::wallet::VoteStrategy& strategy /* = fc::json::from_string("\"vote_none\"").as<TiValue::wallet::VoteStrategy>() */, bool sign_and_broadcast /* = fc::json::from_string("true").as<bool>() */, const std::string& builder_path /* = fc::json::from_string("\"\"").as<std::string>() */)
{
  ...
  return result.as<TiValue::wallet::TransactionBuilder>();
}
...
TiValue::wallet::WalletTransactionEntry CommonApiRpcClient::wallet_get_transaction(const std::string& transaction_id)
{
...
TiValue::wallet::WalletTransactionEntry CommonApiRpcClient::wallet_scan_transaction(const std::string& transaction_id, bool overwrite_existing /* = fc::json::from_string("false").as<bool>() */)
{
...
TiValue::wallet::WalletTransactionEntry CommonApiRpcClient::wallet_account_update_registration(const std::string& account_name, const std::string& pay_from_account, const fc::variant& public_data /* = fc::json::from_string("null").as<fc::variant>() */, uint8_t delegate_pay_rate /* = fc::json::from_string("-1").as<uint8_t>() */)
{
...
TiValue::wallet::WalletTransactionEntry CommonApiRpcClient::wallet_account_update_active_key(const std::string& account_to_update, const std::string& pay_from_account, const std::string& new_active_key /* = fc::json::from_string("\"\"").as<std::string>() */)
{
...
std::vector<TiValue::wallet::WalletAccountEntry> CommonApiRpcClient::wallet_list_accounts() const
{
  fc::variant result = get_json_connection()->async_call("wallet_list_accounts", std::vector<fc::variant>{}).wait();
  return result.as<std::vector<TiValue::wallet::WalletAccountEntry>>();
}
std::vector<TiValue::wallet::WalletAccountEntry> CommonApiRpcClient::wallet_list_unregistered_accounts() const
{
  fc::variant result = get_json_connection()->async_call("wallet_list_unregistered_accounts", std::vector<fc::variant>{}).wait();
  return result.as<std::vector<TiValue::wallet::WalletAccountEntry>>();
}
std::vector<TiValue::wallet::WalletAccountEntry> CommonApiRpcClient::wallet_list_my_accounts() const
{
  fc::variant result = get_json_connection()->async_call("wallet_list_my_accounts", std::vector<fc::variant>{}).wait();
  return result.as<std::vector<TiValue::wallet::WalletAccountEntry>>();
}
std::vector<TiValue::wallet::AccountAddressData> CommonApiRpcClient::wallet_list_my_addresses() const
{
  fc::variant result = get_json_connection()->async_call("wallet_list_my_addresses", std::vector<fc::variant>{}).wait();
  return result.as<std::vector<TiValue::wallet::AccountAddressData>>();
}
TiValue::wallet::WalletAccountEntry CommonApiRpcClient::wallet_get_account(const std::string& account_name) const
{
  fc::variant result = get_json_connection()->async_call("wallet_get_account", std::vector<fc::variant>{fc::variant(account_name)}).wait();
  return result.as<TiValue::wallet::WalletAccountEntry>();
}
...
TiValue::wallet::WalletTransactionEntry CommonApiRpcClient::wallet_asset_issue(const std::string& amount, const std::string& symbol, const std::string& to_account_name, const TiValue::blockchain::Imessage& memo_message /* = fc::json::from_string("\"\"").as<TiValue::blockchain::Imessage>() */)
{
...
TiValue::wallet::WalletTransactionEntry CommonApiRpcClient::wallet_asset_issue_to_addresses(const std::string& symbol, const std::map<std::string, TiValue::blockchain::ShareType>& addresses)
{
...
TiValue::wallet::AccountBalanceSummaryType CommonApiRpcClient::wallet_account_balance(const std::string& account_name /* = fc::json::from_string("\"\"").as<std::string>() */) const
{
...
TiValue::wallet::AccountBalanceIdSummaryType CommonApiRpcClient::wallet_account_balance_ids(const std::string& account_name /* = fc::json::from_string("\"\"").as<std::string>() */) const
{
  ...
  return result.as<TiValue::wallet::AccountBalanceIdSummaryType>();
}
std::vector<TiValue::wallet::PublicKeySummary> CommonApiRpcClient::wallet_account_list_public_keys(const std::string& account_name)
{
  ...
  return result.as<std::vector<TiValue::wallet::PublicKeySummary>>();
}
TiValue::wallet::WalletTransactionEntry CommonApiRpcClient::wallet_delegate_withdraw_pay(const std::string& delegate_name, const std::string& to_account_name, const std::string& amount_to_withdraw)
{
...
TiValue::blockchain::DelegatePaySalary CommonApiRpcClient::wallet_delegate_pay_balance_query(const std::string& delegate_name)
{
  ...
  return result.as<TiValue::blockchain::DelegatePaySalary>();
}
std::map<std::string,TiValue::blockchain::DelegatePaySalary> CommonApiRpcClient::wallet_active_delegate_salary()
{
  fc::variant result = get_json_connection()->async_call("wallet_active_delegate_salary", std::vector<fc::variant>{}).wait();
  return result.as<std::map<std::string,TiValue::blockchain::DelegatePaySalary>>();
}
...
TiValue::blockchain::Asset CommonApiRpcClient::wallet_set_transaction_fee(const std::string& fee)
{
  fc::variant result = get_json_connection()->async_call("wallet_set_transaction_fee", std::vector<fc::variant>{fc::variant(fee)}).wait();
  return result.as<TiValue::blockchain::Asset>();
}
TiValue::blockchain::Asset CommonApiRpcClient::wallet_get_transaction_fee(const std::string& symbol /* = fc::json::from_string("\"\"").as<std::string>() */)
{
...
fc::optional<std::string> CommonApiRpcClient::wallet_dump_account_private_key(const std::string& account_name, const TiValue::wallet::AccountKeyType& key_type) const
{
...
TiValue::wallet::AccountVoteSummaryType CommonApiRpcClient::wallet_account_vote_summary(const std::string& account_name /* = fc::json::from_string("\"\"").as<std::string>() */) const
{
  ...
  return result.as<TiValue::wallet::AccountVoteSummaryType>();
}
TiValue::wallet::VoteSummary CommonApiRpcClient::wallet_check_vote_status(const std::string& account)
{
  fc::variant result = get_json_connection()->async_call("wallet_check_vote_status", std::vector<fc::variant>{fc::variant(account)}).wait();
  return result.as<TiValue::wallet::VoteSummary>();
}
...
fc::variant CommonApiRpcClient::wallet_login_finish(const TiValue::blockchain::PublicKeyType& server_key, const TiValue::blockchain::PublicKeyType& client_key, const fc::ecc::compact_signature& client_signature)
{
...
TiValue::wallet::TransactionBuilder CommonApiRpcClient::wallet_balance_set_vote_info(const TiValue::blockchain::Address& balance_id, const std::string& voter_address /* = fc::json::from_string("\"\"").as<std::string>() */, const TiValue::wallet::VoteStrategy& strategy /* = fc::json::from_string("\"vote_all\"").as<TiValue::wallet::VoteStrategy>() */, bool sign_and_broadcast /* = fc::json::from_string("\"true\"").as<bool>() */, const std::string& builder_path /* = fc::json::from_string("\"\"").as<std::string>() */)
{
...
TiValue::wallet::WalletTransactionEntry CommonApiRpcClient::wallet_publish_slate(const std::string& publishing_account_name, const std::string& paying_account_name /* = fc::json::from_string("\"\"").as<std::string>() */)
{
...
TiValue::wallet::WalletTransactionEntry CommonApiRpcClient::wallet_publish_version(const std::string& publishing_account_name, const std::string& paying_account_name /* = fc::json::from_string("\"\"").as<std::string>() */)
{
...
TiValue::wallet::WalletTransactionEntry CommonApiRpcClient::wallet_collect_genesis_balances(const std::string& account_name)
{
...
TiValue::wallet::WalletTransactionEntry CommonApiRpcClient::wallet_account_retract(const std::string& account_to_retract, const std::string& pay_from_account)
{
...
TiValue::blockchain::PublicKeyType CommonApiRpcClient::wallet_get_account_owner_publickey(const std::string& account_name)
{
  ...
  return result.as<TiValue::blockchain::PublicKeyType>();
}
TiValue::wallet::WalletTransactionEntry CommonApiRpcClient::wallet_transfer_to_contract(double amount_to_transfer, const std::string& asset_symbol, const std::string& from_account_name, const std::string& to_contract, double amount_for_exec)
{
...
std::vector<TiValue::blockchain::Asset> CommonApiRpcClient::wallet_transfer_to_contract_testing(double amount_to_transfer, const std::string& asset_symbol, const std::string& from_account_name, const std::string& to_contract)
{
  ...
  return result.as<std::vector<TiValue::blockchain::Asset>>();
}
...
TiValue::wallet::WalletTransactionEntry CommonApiRpcClient::builder_finalize_and_sign(const TiValue::wallet::TransactionBuilder& builder) const
{
  fc::variant result = get_json_connection()->async_call("builder_finalize_and_sign", std::vector<fc::variant>{fc::variant(builder)}).wait();
  return result.as<TiValue::wallet::WalletTransactionEntry>();
}
std::map<std::string, TiValue::api::MethodData> CommonApiRpcClient::meta_help() const
{
  fc::variant result = get_json_connection()->async_call("meta_help", std::vector<fc::variant>{}).wait();
  return result.as<std::map<std::string, TiValue::api::MethodData>>();
}
...
std::vector<TiValue::blockchain::Asset> CommonApiRpcClient::register_contract_testing(const std::string& owner, const fc::path& codefile)
{
...
TiValue::wallet::WalletTransactionEntry CommonApiRpcClient::upgrade_contract(const std::string& contract_address, const std::string& upgrader_name, const std::string& new_contract_name, const TiValue::blockchain::Imessage& new_contract_desc, const std::string& asset_symbol, const fc::optional<double>& exec_limit)
{
...
std::vector<TiValue::blockchain::Asset> CommonApiRpcClient::upgrade_contract_testing(const std::string& contract_address, const std::string& upgrader_name, const std::string& new_contract_name, const TiValue::blockchain::Imessage& new_contract_desc)
{
...
TiValue::wallet::WalletTransactionEntry CommonApiRpcClient::destroy_contract(const std::string& contract_address, const std::string& destroyer_name, const std::string& asset_symbol, const fc::optional<double>& exec_limit)
{
...
std::vector<TiValue::blockchain::Asset> CommonApiRpcClient::destroy_contract_testing(const std::string& contract_address, const std::string& destroyer_name)
{
...
TiValue::wallet::WalletTransactionEntry CommonApiRpcClient::call_contract(const std::string& contract, const std::string& caller_name, const std::string& function_name, const std::string& params, const std::string& asset_symbol, const fc::optional<double>& call_limit)
{
...
TiValue::blockchain::ContractEntryPrintable CommonApiRpcClient::get_contract_info(const std::string& contract)
{
  fc::variant result = get_json_connection()->async_call("get_contract_info", std::vector<fc::variant>{fc::variant(contract)}).wait();
  return result.as<TiValue::blockchain::ContractEntryPrintable>();
}
std::vector<TiValue::blockchain::BalanceEntry> CommonApiRpcClient::get_contract_balance(const std::string& contract)
{
  fc::variant result = get_json_connection()->async_call("get_contract_balance", std::vector<fc::variant>{fc::variant(contract)}).wait();
  return result.as<std::vector<TiValue::blockchain::BalanceEntry>>();
}
std::vector<TiValue::blockchain::Asset> CommonApiRpcClient::call_contract_testing(const std::string& contract, const std::string& caller_name, const std::string& function_name, const std::string& params)
{
...
TiValue::blockchain::ContractEntryPrintable CommonApiRpcClient::load_contract_to_file(const std::string& contract, const fc::path& file)
{
...
TiValue::blockchain::TransactionIdType CommonApiRpcClient::get_result_trx_id(const TiValue::blockchain::TransactionIdType& request_id)
{
  fc::variant result = get_json_connection()->async_call("get_result_trx_id", std::vector<fc::variant>{fc::variant(request_id)}).wait();
  return result.as<TiValue::blockchain::TransactionIdType>();
}
TiValue::blockchain::TransactionIdType CommonApiRpcClient::get_request_trx_id(const TiValue::blockchain::TransactionIdType& request_id)
{
...
TiValue::wallet::WalletTransactionEntry CommonApiRpcClient::sandbox_call_contract(const std::string& contract, const std::string& caller_name, const std::string& function_name, const std::string& params, const std::string& cost_asset, const fc::optional<double>& callLimit)
{
...
TiValue::wallet::WalletTransactionEntry CommonApiRpcClient::sandbox_upgrade_contract(const std::string& contract_address, const std::string& upgrader_name, const std::string& new_contract_name, const TiValue::blockchain::Imessage& new_contract_desc, const std::string& asset_symbol, const fc::optional<double>& exec_limit)
{
...
std::vector<TiValue::blockchain::Asset> CommonApiRpcClient::sandbox_upgrade_contract_testing(const std::string& contract_address, const std::string& upgrader_name, const std::string& new_contract_name, const TiValue::blockchain::Imessage& new_contract_desc)
{
...
TiValue::wallet::WalletTransactionEntry CommonApiRpcClient::sandbox_destroy_contract(const std::string& contract_address, const std::string& destroyer_name, const std::string& asset_symbol, const fc::optional<double>& exec_limit)
{
...
std::vector<TiValue::blockchain::Asset> CommonApiRpcClient::sandbox_destroy_contract_testing(const std::string& contract_address, const std::string& destroyer_name)
{
...
TiValue::blockchain::ContractEntryPrintable CommonApiRpcClient::sandbox_get_contract_info(const std::string& contract)
{
...
std::vector<TiValue::blockchain::BalanceEntry> CommonApiRpcClient::sandbox_get_contract_balance(const std::string& contract)
{
...
TiValue::wallet::WalletTransactionEntry CommonApiRpcClient::sandbox_transfer_to_contract(double amount_to_transfer, const std::string& asset_symbol, const std::string& from_account_name, const std::string& to_contract, double amount_for_exec)
{
...
TiValue::wallet::AccountBalanceSummaryType CommonApiRpcClient::sandbox_account_balance(const std::string& account_name /* = fc::json::from_string("\"\"").as<std::string>() */)
{
...
TiValue::blockchain::ContractEntryPrintable CommonApiRpcClient::sandbox_load_contract_to_file(const std::string& contract, const fc::path& file)
{
...
std::vector<TiValue::blockchain::Asset> CommonApiRpcClient::sandbox_register_contract_testing(const std::string& owner, const fc::path& codefile)
{
...
std::vector<TiValue::blockchain::Asset> CommonApiRpcClient::sandbox_call_contract_testing(const std::string& contract, const std::string& caller_name, const std::string& function_name, const std::string& params)
{
...
std::vector<TiValue::blockchain::Asset> CommonApiRpcClient::sandbox_transfer_to_contract_testing(double amount_to_transfer, const std::string& asset_symbol, const std::string& from_account_name, const std::string& to_contract)
{
...
vector<TiValue::blockchain::SandboxAccountInfo> CommonApiRpcClient::sandbox_list_my_addresses(const std::string& account_name /* = fc::json::from_string("\"\"").as<std::string>() */)
{
  ...
  return result.as<vector<TiValue::blockchain::SandboxAccountInfo>>();
}
std::string CommonApiRpcClient::get_contract_registered_in_transaction(const TiValue::blockchain::TransactionIdType& trx_id)
{
...
TiValue::blockchain::TransactionIdType CommonApiRpcClient::get_transaction_id_contract_registered(const std::string& contract_id)
{
...
TiValue::blockchain::CodePrintAble CommonApiRpcClient::get_contract_info_from_gpc_file(const fc::path& file)
{
  ...
  return result.as<TiValue::blockchain::CodePrintAble>();
}
...
std::string CommonApiRpcClient::add_script(const fc::path& filename, const TiValue::blockchain::Imessage& description)
{
...
TiValue::wallet::ScriptEntryPrintable CommonApiRpcClient::get_script_info(const std::string& scriptid)
{
  fc::variant result = get_json_connection()->async_call("get_script_info", std::vector<fc::variant>{fc::variant(scriptid)}).wait();
  return result.as<TiValue::wallet::ScriptEntryPrintable>();
}
std::vector<TiValue::wallet::ScriptEntryPrintable> CommonApiRpcClient::list_scripts()
{
  fc::variant result = get_json_connection()->async_call("list_scripts", std::vector<fc::variant>{}).wait();
  return result.as<std::vector<TiValue::wallet::ScriptEntryPrintable>>();
}
...
{
  fc::variant result = get_json_connection()->async_call("get_file_access", std::vector<fc::variant>{fc::variant(requester), fc::variant(file_id), fc::variant(exec_limit)}).wait();
  return result.as<TiValue::wallet::WalletTransactionEntry>();
}
TiValue::wallet::WalletTransactionEntry CommonApiRpcClient::store_file_piece(const std::string& requester, const std::string& file_id, const std::string& file_piece_id, const std::string& node_id, double exec_limit)
{
  fc::variant result = get_json_connection()->async_call("store_file_piece", std::vector<fc::variant>{fc::variant(requester), fc::variant(file_id), fc::variant(file_piece_id), fc::variant(node_id), fc::variant(exec_limit)}).wait();
  return result.as<TiValue::wallet::WalletTransactionEntry>();
}
TiValue::wallet::WalletTransactionEntry CommonApiRpcClient::store_reject(const std::string& file_id, const std::string& file_piece_id, const std::string& node_id, double exec_limit)
{
  fc::variant result = get_json_connection()->async_call("store_reject", std::vector<fc::variant>{fc::variant(file_id), fc::variant(file_piece_id), fc::variant(node_id), fc::variant(exec_limit)}).wait();
  return result.as<TiValue::wallet::WalletTransactionEntry>();
}
TiValue::wallet::WalletTransactionEntry CommonApiRpcClient::confirm_piece_saved(const std::string& confirmer, const std::string& file_id, const std::string& file_piece_id, const std::string& Storage, double exec_limit)
{
  fc::variant result = get_json_connection()->async_call("confirm_piece_saved", std::vector<fc::variant>{fc::variant(confirmer), fc::variant(file_id), fc::variant(file_piece_id), fc::variant(Storage), fc::variant(exec_limit)}).wait();
  return result.as<TiValue::wallet::WalletTransactionEntry>();
}
void CommonApiRpcClient::wallet_set_node_id(const std::string& node_id)
{
  fc::variant result = get_json_connection()->async_call("wallet_set_node_id", std::vector<fc::variant>{fc::variant(node_id)}).wait();
}
std::vector<std::string> CommonApiRpcClient::blockchain_list_file_saved()
{
  fc::variant result = get_json_connection()->async_call("blockchain_list_file_saved", std::vector<fc::variant>{}).wait();
  return result.as<std::vector<std::string>>();
}
std::string CommonApiRpcClient::blockchain_get_file_authorizing_contract(const std::string& file_id)
{
  fc::variant result = get_json_connection()->async_call("blockchain_get_file_authorizing_contract", std::vector<fc::variant>{fc::variant(file_id)}).wait();
  return result.as<std::string>();
}
std::vector<TiValue::blockchain::StoreRequestInfo> CommonApiRpcClient::wallet_list_store_request_for_my_file(const std::string& file_id /* = fc::json::from_string("\"\"").as<std::string>() */)
{
...
std::vector<TiValue::blockchain::FileAccessInfo> CommonApiRpcClient::wallet_get_my_access()
{
  fc::variant result = get_json_connection()->async_call("wallet_get_my_access", std::vector<fc::variant>{}).wait();
  return result.as<std::vector<TiValue::blockchain::FileAccessInfo>>();
}
std::vector<TiValue::blockchain::UploadRequestEntry> CommonApiRpcClient::wallet_get_my_upload_requests()
{
  fc::variant result = get_json_connection()->async_call("wallet_get_my_upload_requests", std::vector<fc::variant>{}).wait();
  return result.as<std::vector<TiValue::blockchain::UploadRequestEntry>>();
}
std::vector<TiValue::blockchain::UploadRequestEntry> CommonApiRpcClient::blockchain_get__upload_requests()
{
...
std::vector<TiValue::blockchain::LocalStoreRequestInfo> CommonApiRpcClient::wallet_get_my_store_request()
{
  ...
  return result.as<std::vector<TiValue::blockchain::LocalStoreRequestInfo>>();
}
vector<string> CommonApiRpcClient::wallet_get_my_store_confirmed()
{
  fc::variant result = get_json_connection()->async_call("wallet_get_my_store_confirmed", std::vector<fc::variant>{}).wait();
  return result.as<vector<string>>();
}
std::vector<TiValue::blockchain::FilePieceInfo> CommonApiRpcClient::wallet_get_my_store_rejected()
{
  fc::variant result = get_json_connection()->async_call("wallet_get_my_store_rejected", std::vector<fc::variant>{}).wait();
  return result.as<std::vector<TiValue::blockchain::FilePieceInfo>>();
}
TiValue::blockchain::FileSaveInfo CommonApiRpcClient::blockchain_get_file_save_node(const std::string& file_id)
{
  fc::variant result = get_json_connection()->async_call("blockchain_get_file_save_node", std::vector<fc::variant>{fc::variant(file_id)}).wait();
  return result.as<TiValue::blockchain::FileSaveInfo>();
}
bool CommonApiRpcClient::download_validation(const std::string& file_id, const std::string& authentication)
{
