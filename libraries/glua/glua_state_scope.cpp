...
namespace TiValue
{
    namespace lua
    {
        namespace lib
        {
            ...
            {
                return TiValue::lua::lib::commit_storage_changes(_L);
            }
            ...
            int GluaStateScope::check_tichain_contract_api_instructions_over_limit()
            {
            ...
            {
                return TiValue::lua::lib::execute_contract_api(_L, contract_name, api_name, arg1, result_json_string);
            }
            ...
            {
                return TiValue::lua::lib::execute_contract_api_by_address(_L, address, api_name, arg1, result_json_string);
            }
            ...
            {
                return TiValue::lua::lib::execute_contract_init_by_address(_L, contract_address, arg1, result_json_string);
            }
            ...
            {
                return TiValue::lua::lib::execute_contract_start_by_address(_L, contract_address, arg1, result_json_string);
            }

            bool GluaStateScope::execute_contract_init(GluaModuleByteStream *stream, const char *arg1, std::string *result_json_string)
            {
                return TiValue::lua::lib::execute_contract_init(_L, "tmp", stream, arg1, result_json_string);
            }
            bool GluaStateScope::execute_contract_start(GluaModuleByteStream *stream, const char *arg1, std::string *result_json_string)
            {
                return TiValue::lua::lib::execute_contract_start(_L, "tmp", stream, arg1, result_json_string);
            }

            bool GluaStateScope::check_contract_bytecode_stream(GluaModuleByteStream *stream)
            {
                return TiValue::lua::lib::check_contract_bytecode_stream(_L, stream);
            }

            bool GluaStateScope::start_repl()
            {
                return TiValue::lua::lib::start_repl(_L);
            }
            bool GluaStateScope::stop_repl()
            {
                return TiValue::lua::lib::stop_repl(_L);
            }
            bool GluaStateScope::start_repl_async()
            {
                return TiValue::lua::lib::start_repl_async(_L);
            }
            bool GluaStateScope::check_repl_running()
            {
                return TiValue::lua::lib::check_repl_running(_L);
            }
            int *GluaStateScope::get_repl_state()
            {
                return TiValue::lua::lib::get_repl_state(_L);
            }

			void GluaStateScope::add_system_extra_libs()
            {
				TiValue::lua::lib::add_system_extra_libs(_L);
            }
