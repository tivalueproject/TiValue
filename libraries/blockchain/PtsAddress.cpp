...
namespace fc
{
    void to_variant(const TiValue::blockchain::PtsAddress& var, variant& vo)
    {
        vo = std::string(var);
    }
    void from_variant(const variant& var, TiValue::blockchain::PtsAddress& vo)
    {
        vo = TiValue::blockchain::PtsAddress(var.as_string());
    }
}
