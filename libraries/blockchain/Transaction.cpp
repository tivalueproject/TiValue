...
namespace TiValue {
    namespace blockchain {
            ...
            uint64_t precision)
        {
            ...
            FC_ASSERT(max_share_supply <= TIV_BLOCKCHAIN_MAX_SHARES, "Max_share_supply must not be bigger than TIV_BLOCKCHAIN_MAX_SHARES!");
        ...
        TiValue::blockchain::ContractIdType Transaction::register_contract(const Code& code, const PublicKeyType& owner, const Asset& initlimit,const Asset& transaction_fee, const map<BalanceIdType, ShareType>& balances)
        {
