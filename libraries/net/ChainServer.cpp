    ...
    namespace net {
        namespace detail {
            ...
            public:
                ...
                std::shared_ptr<TiValue::blockchain::ChainDatabase> _chain_db;
                ...
                ChainServerImpl(std::shared_ptr<TiValue::blockchain::ChainDatabase> chain_ptr, uint16_t port)
                    : _chain_db(chain_ptr),
        ...
        TiValue::net::ChainServer::ChainServer(std::shared_ptr<TiValue::blockchain::ChainDatabase> chain_ptr, uint16_t port)
        ...
        uint16_t TiValue::net::ChainServer::get_listening_port()
        {
            return my->_server_socket.get_port();
        }

    }
} //namespace TiValue::net
