...
static_assert((int)TiValue::net::block_message_type == (int)TiValue::client::block_message_type, "enum values don't match");
static_assert((int)TiValue::net::trx_message_type == (int)TiValue::client::trx_message_type, "enum values don't match");
